...
import com.example.liftrix.domain.progress.ExerciseRankingData as UseCaseExerciseRankingData
import com.example.liftrix.domain.progress.RankedExercise as UseCaseRankedExercise
import com.example.liftrix.domain.progress.PlateauStatus as UseCasePlateauStatus
import com.example.liftrix.domain.progress.PerformanceTrend as UseCasePerformanceTrend
    ...
    private fun loadExerciseRankings() {
        viewModelScope.launch {
            try {
                ...
                result.fold(
                    onSuccess = { rankings ->
                        val viewModelData = convertToViewModelData(rankings)
