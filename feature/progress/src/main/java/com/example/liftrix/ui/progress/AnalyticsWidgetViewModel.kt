 ...
 * - Integrates with ProgressAnalyticsServicePort for data operations
 * - Uses ProgressWidgetResolverPort for dynamic widget selection
 * - Uses StateFlow for reactive UI updates
 * - Implements proper lifecycle management
 * - Handles concurrent operations safely
 * 
 * Dependencies:
 * - ProgressAnalyticsServicePort: Core service for widget operations
 * - AnalyticsWidgetManager: Widget configuration management
 * - ProgressWidgetResolverPort: Dynamic widget resolution based on user level
...
class AnalyticsWidgetViewModel @Inject constructor(
    private val analyticsService: ProgressAnalyticsServicePort,
            ...
            try {
                ...
                result.fold(
                    onSuccess = { rawPreferences ->
                        ...
                        // CRITICAL FIX: Use ProgressWidgetResolverPort for proper widget resolution
                        ...
                        Timber.d("=== WIDGET DEBUG: Resolved ${resolvedWidgets.size} widgets from ProgressWidgetResolverPort")
    ...
    /**
     * Loads dashboard configuration from preferences using ProgressWidgetResolverPort.
     */
    private fun loadConfiguration() {
        ...
        if (preferences != null) {
            ...
            // Use ProgressWidgetResolverPort to get the appropriate configuration
     ...
     * 
     * CRITICAL BUG FIX: This method now uses ProgressWidgetResolverPort to get correct widget IDs
        ...
        viewModelScope.launch {
            try {
                ...
                if (currentPrefs != null) {
                    // Use ProgressWidgetResolverPort to create advanced-level preferences
