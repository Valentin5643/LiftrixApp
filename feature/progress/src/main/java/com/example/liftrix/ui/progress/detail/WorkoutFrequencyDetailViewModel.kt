...
import com.example.liftrix.domain.progress.WorkoutFrequencyData as UseCaseWorkoutFrequencyData
...
class WorkoutFrequencyDetailViewModel @Inject constructor(
    ...
    private fun mapUseCaseDataToUiData(
        useCaseData: com.example.liftrix.domain.progress.WorkoutFrequencyData,
        ...
        viewModelScope.launch {
            try {
                ...
                if (currentState is UiState.Success) {
                    ...
                    val result = analyticsQueryUseCase.exportFrequency(exportRequest)
                    result.fold(
                        onSuccess = { file ->
