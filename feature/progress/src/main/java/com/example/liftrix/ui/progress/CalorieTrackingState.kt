...
data class CalorieTrackingState(
    val calorieSummary: AsyncData<ProgressCalorieSummary> = AsyncData.NotAsked,
    val dailyCalories: AsyncData<List<ProgressDailyCalorieData>> = AsyncData.NotAsked,
    val weeklyTrend: AsyncData<ProgressWeeklyCalorieTrend> = AsyncData.NotAsked,
     ...
     */
    fun getSuccessfulData(): Triple<ProgressCalorieSummary, List<ProgressDailyCalorieData>, ProgressWeeklyCalorieTrend>? {
