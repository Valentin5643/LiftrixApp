 ...
 *     when (event) {
 *         is CalorieTrackingEvent.LoadSummary -> loadProgressCalorieSummary()
 ...
 * - Integrates with ProgressCaloriePort for data operations
...
fun CalorieTrackingEvent.canExecuteConcurrently(): Boolean = when (this) {
    is CalorieTrackingEvent.LoadSummary,
    is CalorieTrackingEvent.LoadDailyCalories,
    is CalorieTrackingEvent.LoadWeeklyTrend -> true
