 ...
 * ```
 */
val LocalFirebaseStorageUrlResolver = compositionLocalOf<ProfileImageUrlResolver?> {
...
fun getCurrentStorageUrlResolver(): ProfileImageUrlResolver? = LocalFirebaseStorageUrlResolver.current
 ...
 * ```
 */
val LocalProfileImageCache = compositionLocalOf<ProfileImageLoader?> {
