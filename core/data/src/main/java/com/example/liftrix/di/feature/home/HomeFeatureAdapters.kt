...
class AppHomeWorkoutAdapter @Inject constructor(
    ...
    override fun getRecentWorkouts(
        ...
        return workoutRepository.getRecentWorkouts(userId, limit)
            .map { workouts -> LiftrixResult.success(workouts.mapNotNull { it.toHomeWorkoutOrNull() }) }
            .catch { throwable ->
                Timber.e(throwable, "Failed to adapt recent workouts")
