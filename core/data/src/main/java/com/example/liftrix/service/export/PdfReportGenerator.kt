...
class PdfReportGenerator @Inject constructor() {
    ...
    companion object {
        ...
        private const val CHARTLESS_PROGRESS_REPORT_PAGE_COUNT = 7
    }
    ...
    private fun drawProgressRecordsPage(
        ...
        try {
            ...
            if (data.workoutRows.size > 8) {
                ...
                drawWrappedText(
                    canvas,
                    "Additional workouts omitted to keep this report within $CHARTLESS_PROGRESS_REPORT_PAGE_COUNT pages.",
                    MARGIN_LEFT,
                    y,
                    CONTENT_WIDTH,
    ...
    private fun drawProgressReportFooter(canvas: Canvas, pageNumber: Int) {
        ...
        val footerText = "Generated by Liftrix - page $pageNumber / $CHARTLESS_PROGRESS_REPORT_PAGE_COUNT"
