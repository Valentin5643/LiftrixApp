 ...
 * 
 * Now integrates with ProgressWidgetResolverPort for dynamic widget resolution
 ...
 * - Integration with ProgressWidgetResolverPort for dynamic widget selection
 */
@Singleton
class AnalyticsWidgetManager @Inject constructor(
     ...
     * 
     * Now uses ProgressWidgetResolverPort for dynamic widget selection instead of hardcoded lists.
     * 
    ...
    /**
     * Get widgets for a configuration using ProgressWidgetResolverPort.
     * 
    ...
    /**
     * Apply preferences to widget configuration using ProgressWidgetResolverPort
     * 
    ...
    fun applyPreferencesToConfiguration(
        ...
        // Use ProgressWidgetResolverPort to get widgets dynamically
    ...
    fun validatePreferences(preferences: WidgetPreferences): PreferencesValidation {
        ...
        // Log for debugging
        Timber.d("Available widget names: ${availableWidgetNames.joinToString(", ")}")
        Timber.d("Preferences visible widgets: ${preferences.visibleWidgets.joinToString(", ")}")
        ...
        if (invalidWidgets.isNotEmpty()) {
            Timber.w("Invalid widget names found: ${invalidWidgets.joinToString(", ")}")
        ...
        if (missingFromOrder.isNotEmpty()) {
            Timber.w("Widget order missing widgets: ${missingFromOrder.joinToString(", ")}")
        ...
        if (preferences.refreshIntervalMinutes !in 1..60) {
            Timber.w("Invalid refresh interval: ${preferences.refreshIntervalMinutes}")
        ...
        Timber.d("Validation result: isValid=${issues.isEmpty()}, issues=${issues.joinToString("; ")}")
    ...
    /**
     * Applies a dashboard configuration to existing widget preferences using ProgressWidgetResolverPort.
     * 
    ...
    fun applyConfigurationToPreferences(
        ...
        // Get widgets from ProgressWidgetResolverPort based on configuration
    ...
    /**
     * Creates default widget preferences for a user based on configuration using ProgressWidgetResolverPort.
     * 
    ...
    fun createDefaultPreferences(
        ...
        // Use ProgressWidgetResolverPort to create default preferences
    ...
    fun reorderWidget(
        ...
        // Get current widgets from configuration using ProgressWidgetResolverPort
