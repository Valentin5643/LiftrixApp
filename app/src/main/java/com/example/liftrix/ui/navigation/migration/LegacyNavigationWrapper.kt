    ...
    fun getMigrationSuggestion(route: String): String? {
        ...
        return if (liftrixRoute != null) {
            when (liftrixRoute) {
                ...
                is LiftrixRoute.AIChatbot -> "Replace with: navController.navigate(LiftrixRoute.AIChatbot())"
                ...
                is LiftrixRoute.SyncSettings -> "Replace with: navController.navigate(LiftrixRoute.SyncSettings)"
                ...
                is LiftrixRoute.FollowersList -> "Replace with: navController.navigate(LiftrixRoute.FollowersList(userId, listType))"
                ...
                is LiftrixRoute.TemplateBuddyShare -> "Replace with: navController.navigate(LiftrixRoute.TemplateBuddyShare(templateId))"
                is LiftrixRoute.WorkoutSharedWithYou -> "Replace with: navController.navigate(LiftrixRoute.WorkoutSharedWithYou(shareId))"
                is LiftrixRoute.WorkoutShareInbox -> "Replace with: navController.navigate(LiftrixRoute.WorkoutShareInbox(senderId))"
                ...
                LiftrixRoute.AIDisclaimer -> "Replace with: navController.navigate(LiftrixRoute.AIDisclaimer)"
                LiftrixRoute.CommunityGuidelines -> "Replace with: navController.navigate(LiftrixRoute.CommunityGuidelines)"
                LiftrixRoute.ContentModerationPolicy -> "Replace with: navController.navigate(LiftrixRoute.ContentModerationPolicy)"
                LiftrixRoute.RefundSubscriptionPolicy -> "Replace with: navController.navigate(LiftrixRoute.RefundSubscriptionPolicy)"
