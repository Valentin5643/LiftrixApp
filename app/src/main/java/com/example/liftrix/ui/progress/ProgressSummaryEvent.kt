...
sealed class ProgressSummaryEvent : ViewModelEvent {
     ...
     * from the ProgressDataService.
     * 
     * Processing:
     * - Checks user authentication status
     * - Sets loading state in UI
     * - Calls ProgressDataService.getProgressSummary()
     ...
     * - Sets loading state
     * - Calls ProgressDataService.getProgressSummary() with new range
     * - Updates state with new data
     * 
     * Example usage:
     * ```kotlin
     ...
     * - Calls ProgressDataService.refreshAllData()
