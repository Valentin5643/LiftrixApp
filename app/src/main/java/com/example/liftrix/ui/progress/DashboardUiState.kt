...
data class DashboardUiState(
     ...
     */
    val widgetData: Map<String, GetWidgetDataUseCase.WidgetData> = emptyMap(),
...
fun DashboardUiState.withWidgetData(
    widgetId: String, 
    data: GetWidgetDataUseCase.WidgetData
 ...
 * from WidgetResolver, ensuring correct widget counts for all user levels.
 * 
