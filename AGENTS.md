...
This document mirrors CLAUDE.md and serves as the contributor guide for this repository.
...
- Use Cases: `*UseCase.kt` in `domain/usecase/` (Note: 82 old use cases consolidated into 25)
